...
const description =
  'Lewis Hadden - Freelance Senior Full Stack Developer & Lead Developer specializing in React, Next.js, TypeScript, Node.js, Azure, and AWS. Available for freelance contracts and permanent positions. 8+ years experience building enterprise applications.';
const keywords = [
  'Jonas Pedersen',
